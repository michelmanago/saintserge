        ...
        const message = {
            ...
            <div style="padding-left:0.5rem;padding-right:0.5rem;">
                ...
                <div style="padding-left: 0.5rem; padding-right: 0.5rem;">
                    ...
                    <a target="_" style="font-size: 0.8rem; line-height: 2rem; color: #6cb7d4; text-decoration: none; padding-top: 50px;" href="${process.env.DOMAIN}/unsubscribe?email=${adherent.email}">Se désabonner</a>
                </div>
                </div>
            </div>
            </html>
